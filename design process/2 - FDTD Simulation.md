...
- The ring resonator visualization was designed with a radius of 3um, while the INTERCONNECT circuit ring resonators use a radius of 5um. The visualization could be improved by making the radius match the circuit it's simulating.
