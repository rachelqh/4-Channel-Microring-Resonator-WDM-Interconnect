...
I studied the following chapters to develop an understanding of the physics underlying modern photonic devices and systems:
...
I studied the following chapters to learn practical silicon photonics design techniques. The textbook also provided MATLAB examples and ANSYS Lumerical-based design workflows that were useful throughout the project.
